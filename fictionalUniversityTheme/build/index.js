    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`
            ...
            <textarea readonly class="note-body-field">${response.content.raw.trim()}</textarea>
...
class Search {
  ...
  KeyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.OverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input , textarea").is(':isfocus')) {
      // 83 is the s key
      this.openOverlay();
